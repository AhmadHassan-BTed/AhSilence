package com.bted.ahsilence.ui.screens.components
...
fun CalibratorRing(
    ...
    // Premium Synthesizer Theme Palette
    val surfaceColor = Color(0xFF0A0A0A) // Deep OLED Black
    val gridColor = Color(0xFF2A2A2A)    // Subtle hardware-gray
    val accentColor = Color(0xFFFF5A00)  // High-visibility Neon Amber
